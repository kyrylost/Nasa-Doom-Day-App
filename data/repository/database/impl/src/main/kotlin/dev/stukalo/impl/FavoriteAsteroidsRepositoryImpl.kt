...
class FavoriteAsteroidsRepositoryImpl
    @Inject
    constructor(
        ...
        override fun getAsteroidById(id: String?) = asteroidsDataSource.getAsteroidById(id)?.mapToAsteroidRepo()
        ...
        override fun updateIsShownField(
            id: String,
            isShown: Boolean,
        ) = asteroidsDataSource.updateIsShownField(id, isShown)
    }
