...
import dev.stukalo.ui.R
import dev.stukalo.ui.zoomlayout.ZoomApi.ZoomType
...
open class ZoomLayout private constructor(
    ...
    init {
        ...
        @ZoomType val minZoomMode =
            a.getInteger(
                R.styleable.ZoomEngine_minZoomType,
                ZoomApi.MIN_ZOOM_DEFAULT_TYPE,
            )

        @ZoomType val maxZoomMode =
            a.getInteger(
                R.styleable.ZoomEngine_maxZoomType,
                ZoomApi.MAX_ZOOM_DEFAULT_TYPE,
            )
        val transformation =
            a.getInteger(
                R.styleable.ZoomEngine_transformation,
                ZoomApi.TRANSFORMATION_CENTER_INSIDE,
            )
        val transformationGravity =
            a.getInt(
                R.styleable.ZoomEngine_transformationGravity,
