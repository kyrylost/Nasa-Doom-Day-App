...
interface ZoomApi {
    ...
    @Retention(AnnotationRetention.SOURCE)
    @IntDef(
        dev.stukalo.ui.zoomlayout.Alignment.BOTTOM,
        dev.stukalo.ui.zoomlayout.Alignment.CENTER_VERTICAL,
        dev.stukalo.ui.zoomlayout.Alignment.NONE_VERTICAL,
        dev.stukalo.ui.zoomlayout.Alignment.TOP,
        dev.stukalo.ui.zoomlayout.Alignment.LEFT,
        dev.stukalo.ui.zoomlayout.Alignment.CENTER_HORIZONTAL,
        dev.stukalo.ui.zoomlayout.Alignment.NONE_HORIZONTAL,
        dev.stukalo.ui.zoomlayout.Alignment.RIGHT,
        dev.stukalo.ui.zoomlayout.Alignment.CENTER,
        dev.stukalo.ui.zoomlayout.Alignment.NONE,
        flag = true,
    )
    ...
    fun setTransformation(
        @Transformation transformation: Int,
    ) {
    ...
    companion object {
         ...
         */
        const val ALIGNMENT_DEFAULT = dev.stukalo.ui.zoomlayout.Alignment.CENTER
    }
}
