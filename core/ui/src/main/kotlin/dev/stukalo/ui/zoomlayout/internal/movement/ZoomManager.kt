package dev.stukalo.ui.zoomlayout.internal.movement

import dev.stukalo.ui.zoomlayout.OverZoomRangeProvider
...
internal class ZoomManager(
     ...
     */
    @ZoomApi.Zoom
    internal fun realZoomToZoom(
        @ZoomApi.RealZoom realZoom: Float,
    ): Float {
     ...
     */
    internal fun setMaxZoom(
        maxZoom: Float,
        @ZoomApi.ZoomType type: Int,
    ) {
        if (maxZoom < 0) {
