package dev.stukalo.ui.zoomlayout
...
import dev.stukalo.ui.zoomlayout.ZoomApi.*
import dev.stukalo.ui.zoomlayout.internal.StateController
import dev.stukalo.ui.zoomlayout.internal.UpdatesDispatcher
import dev.stukalo.ui.zoomlayout.internal.gestures.PinchDetector
import dev.stukalo.ui.zoomlayout.internal.gestures.ScrollFlingDetector
import dev.stukalo.ui.zoomlayout.internal.matrix.MatrixController
import dev.stukalo.ui.zoomlayout.internal.matrix.MatrixUpdate
import dev.stukalo.ui.zoomlayout.internal.movement.PanManager
import dev.stukalo.ui.zoomlayout.internal.movement.ZoomManager
...
/**
    ...
    constructor(context: Context) : ZoomApi {
        ...
        private inner class Callbacks :
             ...
             */
            override fun onMatrixSizeChanged(
                oldZoom: Float,
                firstTime: Boolean,
            ) {
                LOG.w(
                    "onMatrixSizeChanged: firstTime:",
                    firstTime,
                    "oldZoom:",
                    oldZoom,
                    "transformation:",
                    transformationType,
                    "transformationZoom:",
                    zoomManager.transformationZoom,
                )
                ...
                LOG.i(
                    "onMatrixSizeChanged: newTransformationZoom:",
                    zoomManager.transformationZoom,
                    "newRealZoom:",
                    realZoom,
                    "newZoom:",
            ...
            override fun cleanupState(
                @StateController.State oldState: Int,
            ) {
                when (oldState) {
        ...
        abstract class SimpleListener : Listener {
             ...
             */
            internal abstract fun onUpdate(
                engine: ZoomEngine,
                panX: Float,
                panY: Float,
                zoom: Float,
        ...
        override fun setAlignment(
            @ZoomApi.Alignment alignment: Int,
        ) {
        ...
        fun setContainer(container: View) {
            ...
            this.container.addOnAttachStateChangeListener(
         ...
         */
        override fun panBy(
            @AbsolutePan dx: Float,
            @AbsolutePan dy: Float,
            animate: Boolean,
        ) {
         ...
         * @param animate  whether to animate the transition
         */
        override fun realZoomTo(
            @RealZoom realZoom: Float,
            animate: Boolean,
        ) {
